...
export const EXERCISE_META = {
  ...
  "Arnold Press":                                { p: ["Delts"], s: ["Triceps","Core"], eq: ["dumbbell"], req: { overhead: 3 } },
  ...
  "Band Lateral Walk":                           { p: ["Hip Abductors"], s: ["Glutes","Balance"], eq: ["band"], req: { gait: 2 } },
  ...
  "Bicycle Crunches":                            { p: ["Obliques"], s: ["Core"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  "Bird Dog":                                    { p: ["Core"], s: ["Lower Back","Glutes","Stabilizers"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Chair-Assisted Mini Squats":                  { p: ["Quads"], s: ["Glutes","Balance"], eq: ["chair","bodyweight"], req: { sit_to_stand: 1 } },
  ...
  "Dead Bug":                                    { p: ["Core"], s: ["Stabilizers"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Glute Bridge":                                { p: ["Glutes"], s: ["Hamstrings","Core"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  "Glute Bridge (warm-up reps)":                 { p: ["Glutes"], s: ["Hamstrings"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  "Glute Bridges":                               { p: ["Glutes"], s: ["Hamstrings","Core"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Leg Raises":                                  { p: ["Core"], s: ["Hip Flexors"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Modified Side Plank (knees down)":            { p: ["Obliques"], s: ["Core","Stabilizers"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Overhead Press":                              { p: ["Delts"], s: ["Triceps","Core"], eq: ["barbell"], req: { overhead: 3 } },
  ...
  "Plank":                                       { p: ["Core"], s: ["Stabilizers"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  ...
  "Single Leg Stand (hold support)":             { p: ["Balance"], s: ["Ankles","Glutes"], eq: ["bodyweight"], req: { single_leg: 1 } },
  "Sit-to-Stand (stand up quickly)":              { p: ["Quads"], s: ["Glutes","Balance"], eq: ["chair","bodyweight"], req: { sit_to_stand: 3 } },
  "Table Inverted Row":                           { p: ["Mid Back"], s: ["Lats","Biceps"], eq: ["bodyweight"] },
  "Tandem Walk (heel-to-toe)":                    { p: ["Balance"], s: ["Ankles","Glutes"], eq: ["bodyweight"], req: { tandem: 4 } },
  "Towel Door Row":                               { p: ["Mid Back"], s: ["Lats","Biceps"], eq: ["bodyweight"] },
  "Walk":                                         { p: ["Cardio"], s: ["Recovery"], eq: ["none"], req: { gait: 3 } },
  "Sit-to-Stand":                                { p: ["Quads"], s: ["Glutes","Balance"], eq: ["chair","bodyweight"], req: { sit_to_stand: 1 } },
  ...
  "Standing Wall Push-ups":                      { p: ["Chest"], s: ["Triceps","Front Delts"], eq: ["wall","bodyweight"], req: { gait: 2 } },
  ...
  "Straight Leg Raises (lying)":                 { p: ["Quads"], s: ["Hip Flexors","Core"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
  "Sumo Deadlift":                               { p: ["Glutes","Quads"], s: ["Lower Back","Adductors"], eq: ["barbell"] },
  "Superman Hold":                               { p: ["Lower Back"], s: ["Glutes"], eq: ["bodyweight"], req: { floor_transfer: 1 } },
...
// What a person must be able to do before this movement may be put in front
// of them. Null means no requirement — seated, supported, safe for anyone who
// can sit in a chair.
//
// The levels themselves live in src/assessment.js. Keeping the requirement on
// the exercise rather than in a second table is deliberate: one place per
// movement, so the two cannot drift apart.
export function getExerciseRequirement(name) {
