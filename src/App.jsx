...
const T = {
  en: {
    ...
    chooseMeal: "??? Choose", chooseWorkout: "??? Choose Workout Type",
    writeManual: "?? Write", memberSince: "Member since", yourTrainer: "Your Trainer",
  ...
  ar: {
    ...
    newMember: "??? ????? ???? ??? ?", welcome: "?????",
    profile: "????? ??????", workout: "??????", nutrition: "???????", progress: "??????",
    dashboard: "???? ??????", clients: "???????", aiTools: "????? ?????? ?????????", plans: "?????", requests: "???????",
    addClient: "+ ?????", edit: "?????", save: "???", cancel: "?????", logout: "????",
    age: "?????", weight: "?????", height: "?????", goal: "?????", gender: "?????",
    male: "???", female: "????", active: "???", disabled: "?????",
    shareLogin: "?????? ?????? ??????", approve: "??????", reject: "???",
    noPlan: "?? ???? ???", trainerWillAdd: "????? ?????? ???? ??????",
    chooseMeal: "??? ??????", chooseWorkout: "??? ???? ???? ???????",
    writeManual: "?? ?????", memberSince: "??? ???", yourTrainer: "?????",
    bmi: "???? ???? ?????", tdee: "?????? ?????????", maintenance: "???????", target: "?????",
    activityLevel: "????? ??????", fullName: "????? ??????", phone: "??????",
    passwordAuto: "???? ?????? (???? = ??????)", addShare: "????? ??????? ?",
    credentialsSent: "??? ????? ??????!", shareDetails: "???? ?????? ?????? ??",
    sendWhatsapp: "?? ????? ??? ??????", copyCredentials: "?? ??? ????????",
    downloadPDF: "?? ????? PDF", close: "?????",
    registrationLink: "???? ???????", copyLink: "?? ???",
    pendingRequests: "??????? ???????", noRequests: "?? ???? ?????",
    invalidCredentials: "?????? ??? ?????.", accountDisabled: "?? ????? ?????.",
    regSubmitted: "?? ????? ?????!", regApproval: "?????? ?????? ?????? ??? ??????.",
    joinUs: "???? ?????", submitRequest: "????? ????? ?",
    alreadyAccount: "???? ?????", loginHere: "????? ??????",
    goalsDistribution: "????? ???????", total: "???????", pending: "????",
    selectClient: "???? ??????", pdfTitle: "??? ???????",
    workoutSystem: "???? ???????", selectSystem: "???? ???? ???????",
...
const WORKOUT_SYSTEMS = [
  {
    id: "ppl", name: "Push / Pull / Legs", nameAr: "??? / ??? / ????",
    color: "#ef4444", emoji: "??",
  ...
  {
    id: "upperlower", name: "Upper / Lower Split", nameAr: "????? ???? / ????",
    color: "#f59e0b", emoji: "?",
  ...
  {
    id: "fst7", name: "FST-7 Training", nameAr: "????? FST-7",
    color: "#9333ea", emoji: "??",
  ...
  {
    id: "superset", name: "Superset Training", nameAr: "????? ?????????",
    color: "#22c55e", emoji: "?",
  ...
  {
    id: "circuit", name: "Circuit Training", nameAr: "??????? ???????",
    color: "#60a5fa", emoji: "??",
  ...
  {
    id: "fullbody", name: "Full Body Training", nameAr: "????? ????? ??????",
    color: "#f97316", emoji: "???",
  ...
  {
    id: "hiit", name: "HIIT Training", nameAr: "????? HIIT",
    color: "#ef4444", emoji: "??",
  ...
  {
    id: "crossfit", name: "CrossFit Style", nameAr: "????? ???????",
    color: "#0ea5e9", emoji: "??",
  ...
  {
    id: "arnold", name: "Arnold Split", nameAr: "????? ??????",
    color: "#d4af37", emoji: "??",
  ...
  {
    id: "homebw", name: "Home Bodyweight", nameAr: "?????? ?????? ???? ?????",
    color: "#10b981", emoji: "??",
  ...
  {
    id: "senior75", name: "Senior Fitness 75+", nameAr: "????? ???? ???? 75+",
    color: "#06b6d4", emoji: "??",
  ...
  {
    id: "lowback", name: "Lower Back Pain Relief", nameAr: "????? ???? ???? ?????",
    color: "#f43f5e", emoji: "??",
  ...
  {
    id: "shoulder", name: "Shoulder Pain Rehab", nameAr: "???? ?????? ???? ?????",
    color: "#8b5cf6", emoji: "??",
  ...
  {
    id: "kneefriendly", name: "Knee Pain Friendly", nameAr: "?????? ?????? ???? ??????",
    color: "#eab308", emoji: "??",
...
// -- MEAL PLANS ---------------------------------------------
const MEALS = [
  { id: "kerala", name: "Kerala Balanced", nameAr: "???? ??????", emoji: "??", color: "#f59e0b", image: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Nutrition/Meal_Kerala.jpeg", baseCal: 1800, meals: [{ mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Breakfast.jpeg", time: "7:00", name: "Breakfast", nameAr: "?????", items: "Puttu 150g + Kadala curry 120g + Banana × 1", cal: 380, p: 14, c: 62, f: 8 }, { mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Snack1.jpeg", time: "10:00", name: "Snack", nameAr: "???? ?????", items: "Coconut water 200ml + Nuts 20g", cal: 180, p: 4, c: 22, f: 9 }, { mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Lunch.jpeg", time: "13:00", name: "Lunch", nameAr: "????", items: "Brown rice 150g + Dal 100g + Fish curry 120g + Veg 80g", cal: 520, p: 32, c: 68, f: 12 }, { mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Snack2.jpeg", time: "16:00", name: "Snack", nameAr: "???? ?????", items: "Banana × 1 + Green tea 200ml", cal: 120, p: 2, c: 28, f: 0 }, { mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Dinner.jpeg", time: "19:00", name: "Dinner", nameAr: "????", items: "Chapati × 3 + Chicken curry 150g + Salad 80g", cal: 480, p: 38, c: 52, f: 10 }] },
  { id: "protein", name: "High Protein", nameAr: "?????? ????", emoji: "??", color: "#ef4444", image: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Nutrition/Meal_Protein.jpeg", baseCal: 2200, meals: [{ time: "7:00", name: "Breakfast", nameAr: "?????", items: "Egg whites × 6 + Oats 60g + Milk 200ml", cal: 450, p: 42, c: 38, f: 12 }, { time: "10:00", name: "Snack", nameAr: "???? ?????", items: "Protein shake 30g + Apple × 1", cal: 250, p: 25, c: 30, f: 4 }, { time: "13:00", name: "Lunch", nameAr: "????", items: "Grilled chicken 200g + Brown rice 120g + Veg 80g", cal: 550, p: 48, c: 55, f: 10 }, { time: "16:30", name: "Pre-workout", nameAr: "??? ???????", items: "Banana × 1 + Peanut butter toast 40g", cal: 320, p: 10, c: 48, f: 10 }, { time: "19:30", name: "Dinner", nameAr: "????", items: "Grilled fish 180g + Sweet potato 150g + Salad 80g", cal: 420, p: 40, c: 42, f: 8 }] },
  { id: "fatburn", name: "Fat Burn", nameAr: "??? ??????", emoji: "??", color: "#22c55e", image: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Nutrition/Meal_FatBurn.jpeg", baseCal: 1500, meals: [{ time: "7:00", name: "Breakfast", nameAr: "?????", items: "Greek yogurt 150g + Berries 60g + Chia 10g", cal: 220, p: 18, c: 22, f: 6 }, { time: "10:00", name: "Snack", nameAr: "???? ?????", items: "Cucumber 100g + Hummus 40g", cal: 120, p: 5, c: 14, f: 5 }, { time: "13:00", name: "Lunch", nameAr: "????", items: "Grilled chicken salad 200g + Olive oil 10ml", cal: 380, p: 35, c: 20, f: 14 }, { time: "16:00", name: "Snack", nameAr: "???? ?????", items: "Almonds 20g + Black coffee 150ml", cal: 170, p: 6, c: 6, f: 14 }, { time: "19:00", name: "Dinner", nameAr: "????", items: "Steamed fish 150g + Vegetables 100g + Dal soup 100g", cal: 380, p: 38, c: 28, f: 8 }] },
  { id: "veg", name: "Vegetarian", nameAr: "?????", emoji: "??", color: "#60a5fa", image: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Nutrition/Meal_Vegetarian.jpeg", baseCal: 1900, meals: [{ time: "7:00", name: "Breakfast", nameAr: "?????", items: "Idli × 4 + Sambar 100g + Chutney 30g", cal: 360, p: 12, c: 68, f: 6 }, { time: "10:00", name: "Snack", nameAr: "???? ?????", items: "Fruit bowl 150g + Buttermilk 200ml", cal: 200, p: 6, c: 38, f: 2 }, { mealImg: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Meals/KB_Lunch.jpeg", time: "13:00", name: "Lunch", nameAr: "????", items: "Brown rice 150g + Rajma 100g + Paneer 80g + Salad 60g", cal: 560, p: 28, c: 72, f: 14 }, { time: "16:00", name: "Snack", nameAr: "???? ?????", items: "Roasted chana 40g + Green tea 200ml", cal: 180, p: 10, c: 28, f: 4 }, { time: "19:00", name: "Dinner", nameAr: "????", items: "Roti × 3 + Dal makhani 120g + Veg curry 100g", cal: 480, p: 22, c: 72, f: 10 }] },
  { id: "bulk", name: "Muscle Builder", nameAr: "???? ???????", emoji: "???", color: "#9333ea", image: "https://lycpyoefqwgrkqgtrmrp.supabase.co/storage/v1/object/public/exercise-photos/Nutrition/Meal_Muscle.jpeg", baseCal: 2800, meals: [{ time: "7:00", name: "Breakfast", nameAr: "?????", items: "Eggs × 4 + Oats 80g + Banana × 1 + Full fat milk 250ml", cal: 620, p: 38, c: 78, f: 16 }, { time: "10:00", name: "Snack", nameAr: "???? ?????", items: "Mass gainer 60g + Dates 40g", cal: 480, p: 32, c: 72, f: 8 }, { time: "13:00", name: "Lunch", nameAr: "????", items: "White rice 180g + Chicken 250g + Dal 100g + Ghee 10g", cal: 680, p: 52, c: 80, f: 18 }, { time: "16:30", name: "Pre-workout", nameAr: "??? ???????", items: "Banana × 2 + Peanut butter 30g + Toast × 2", cal: 420, p: 14, c: 68, f: 12 }, { time: "20:00", name: "Dinner", nameAr: "????", items: "Chapati × 4 + Mutton curry 200g + Milk 200ml", cal: 680, p: 48, c: 78, f: 20 }] },
];
...
const PAL = [
  { id: "sedentary", en: "Sedentary", ar: "????", desc_en: "No exercise", desc_ar: "?? ??????", factor: 1.2, icon: "??" },
  { id: "light", en: "Light", ar: "????", desc_en: "1-3 days/week", desc_ar: "1-3 ????/?????", factor: 1.375, icon: "??" },
  { id: "moderate", en: "Moderate", ar: "?????", desc_en: "3-5 days/week", desc_ar: "3-5 ????/?????", factor: 1.55, icon: "??" },
  { id: "active", en: "Active", ar: "???", desc_en: "6-7 days/week", desc_ar: "6-7 ????/?????", factor: 1.725, icon: "??" },
  { id: "very_active", en: "Very Active", ar: "??? ????", desc_en: "Physical job", desc_ar: "??? ????", factor: 1.9, icon: "??" },
];
...
const TRAINER = { name: "MUHAMMED RAFI", designation: "Certified Personal Trainer", designationAr: "???? ???? ?????", whatsapp: "97471000786", appUrl: "https://www.physicaldefinition.com" };
...
const goalCal = (tdee, goal) => {
  if (goal === "Weight Loss" || goal === "????? ?????") return Math.round(tdee * 0.8);
  if (goal === "Muscle Gain" || goal === "???? ???????") return Math.round(tdee * 1.15);
  return tdee;
};
...
function generatePDF(client, lang) {
  ...
  const getGifForPDF = (exName) => {
    ...
    return url ? `<img src="${url}" alt="${exName}" style="width:160px;height:100px;object-fit:contain;border-radius:8px;background:#fff;" />` : `<div style="width:160px;height:100px;background:#f5f5f5;border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:24px;">???</div>`;
  };
  ...
  ` : client.workoutPlan ? `
    <div class="section">
      <div class="section-title" style="color:#d4af37">? ${isAr ? "??? ???????" : "Workout Plan"}</div>
  ...
  const nutritionHTML = mealPlan ? (() => {
    ...
    <div class="section">
      ...
      <div class="macro-grid">
        <div class="macro-box" style="border-color:${mealPlan.color}"><div class="macro-val" style="color:${mealPlan.color}">${target}</div><div class="macro-label">${isAr ? "??????? ?????????" : "Target Cal"}</div></div>
        <div class="macro-box"><div class="macro-val" style="color:#ef4444">${tot.p}g</div><div class="macro-label">${isAr ? "??????" : "Protein"}</div></div>
        <div class="macro-box"><div class="macro-val" style="color:#f59e0b">${tot.c}g</div><div class="macro-label">${isAr ? "????" : "Carbs"}</div></div>
        <div class="macro-box"><div class="macro-val" style="color:#60a5fa">${tot.f}g</div><div class="macro-label">${isAr ? "????" : "Fat"}</div></div>
      </div>
      <table class="ex-table">
        <tr><th>${isAr ? "?????" : "Time"}</th><th>${isAr ? "??????" : "Meal"}</th><th>${isAr ? "???????" : "Foods"}</th><th>${isAr ? "?????" : "Cal"}</th><th>P/C/F</th></tr>
  ...
  `;
    ...
    <div class="section">
      <div class="section-title" style="color:#22c55e">?? ${isAr ? "??? ???????" : "Nutrition Plan"}</div>
...
<div class="container">
  ...
  <div class="section">
    <div class="section-title">?? ${isAr ? "??????? ??????" : "Client Information"}</div>
    <div class="client-grid">
      <div class="info-box"><div class="info-val">${client.name}</div><div class="info-label">${isAr ? "?????" : "Name"}</div></div>
      <div class="info-box"><div class="info-val">${client.age} ${isAr ? "???" : "yrs"}</div><div class="info-label">${t.age}</div></div>
      ...
      <div class="info-box"><div class="info-val">${bmi} <span class="bmi-badge" style="background:${parseFloat(bmi)<25?"#d1fae5":"#fef3c7"};color:${parseFloat(bmi)<25?"#065f46":"#92400e"}">${parseFloat(bmi)<18.5?(isAr?"????":"Underweight"):parseFloat(bmi)<25?(isAr?"???":"Healthy"):parseFloat(bmi)<30?(isAr?"?????":"Overweight"):(isAr?"?????":"Obese")}</span></div><div class="info-label">BMI</div></div>
      <div class="info-box"><div class="info-val">${client.goal}</div><div class="info-label">${t.goal}</div></div>
    </div>
    <div class="macro-grid">
      <div class="macro-box" style="border-color:#d4af37"><div class="macro-val" style="color:#d4af37">${tdee}</div><div class="macro-label">${isAr ? "???????" : "Maintenance"} kcal</div></div>
      <div class="macro-box" style="border-color:#22c55e"><div class="macro-val" style="color:#22c55e">${target}</div><div class="macro-label">${isAr ? "?????" : "Target"} kcal</div></div>
      <div class="macro-box"><div class="macro-val" style="color:#ef4444">${protein}g</div><div class="macro-label">${isAr ? "??????" : "Protein"}</div></div>
      <div class="macro-box"><div class="macro-val" style="color:#60a5fa">${fat}g</div><div class="macro-label">${isAr ? "????" : "Fat"}</div></div>
    </div>
    <p style="font-size:12px;color:#999">${pal.icon} ${isAr ? "????? ??????" : "Activity Level"}: <strong>${isAr ? pal.ar : pal.en}</strong> — ${isAr ? pal.desc_ar : pal.desc_en}</p>
  </div>
    ...
    <div style={{ background: G.surf2, borderRadius: 12, overflow: "hidden", border: `1px solid ${color}22` }}>
      ...
      <div style={{ padding: "10px 12px 12px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 5, marginBottom: 8 }}>
          {[
            { l: isAr ? "???????" : "Sets", v: exercise.sets, c: color },
            { l: isAr ? "?????" : "Reps", v: exercise.reps, c: G.green },
            { l: isAr ? "????" : "Rest", v: exercise.rest, c: G.amber },
          ].map(x => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
        {WORKOUT_SYSTEMS.map(ws => (
          <div key={ws.id} className="btn card" onClick={() => setSel(sel === ws.id ? null : ws.id)}
            ...
            <div style={{ fontSize: 11, color: G.muted, marginTop: 3 }}>{ws.days.length} {isAr ? "????" : "days"}</div>
          </div>
        ))}
      </div>
      ...
      {sel && (() => {
        ...
        return (
          <div>
            ...
            <Btn ch={`? ${isAr ? "????? ??? ??????" : "Apply This System"}`} v="gold" full onClick={() => onSelect(ws)} sx={{ padding: "13px", fontSize: 14, fontWeight: 700 }} />
          </div>
        );
      })()}
    </div>
  ...
  return (
    <div dir={isAr ? "rtl" : "ltr"}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
        <div className="sf gd" style={{ fontSize: 20, fontWeight: 700 }}>{t.chooseMeal} {isAr ? "????? ????????" : "Meal Plan"}</div>
        <button className="btn" onClick={onClose} style={{ background: "none", color: G.muted, fontSize: 20 }}>?</button>
      </div>
      {client && <div style={{ fontSize: 12, color: G.muted, marginBottom: 14, background: G.surf2, borderRadius: 8, padding: "7px 12px" }}>{isAr ? "????? ??" : "Target for"} {client.name}: <strong style={{ color: G.gold }}>{target} kcal</strong> <span style={{ fontSize: 10, color: G.dim }}>— {isAr ? "???? ??? ??????? ????????" : "portions auto-adjusted to match"}</span></div>}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
        {MEALS.map(p => {
          ...
          return (
            <div key={p.id} className="card btn" onClick={() => setSel(sel === p.id ? null : p.id)}
              ...
              <div style={{ padding: "9px 10px 11px" }}>
                ...
                <div style={{ fontSize: 10, color: p.color, marginTop: 3, fontWeight: 700 }}>{scaledCal} kcal {client && scaledCal !== p.baseCal && <span style={{ color: G.dim, fontWeight: 400 }}>({isAr ? "??????" : "adjusted"})</span>}</div>
              </div>
            </div>
          );
        })}
          ...
          <div>
            {client && plan.scaleFactor && Math.abs(plan.scaleFactor - 1) > 0.03 && (
              <div style={{ fontSize: 11, color: G.gold, marginBottom: 10, background: `${plan.color}10`, borderRadius: 7, padding: "6px 10px" }}>
                ?? {isAr ? "?? ??? ??????? ??????" : "Portions scaled by"} ×{plan.scaleFactor.toFixed(2)} {isAr ? "??????? ????" : "to match your target"}
              </div>
            )}
            ...
            <Btn ch={`? ${isAr ? "????? ??? ?????" : "Add This Plan"}`} v="gold" full onClick={() => onSelect(plan, tot, target)} sx={{ padding: "12px", fontSize: 14, fontWeight: 700 }} />
          </div>
        );
      })()}
    </div>
...
function PlansTab({ clients, selC, setSelC, setClients, lang, onUpdate }) {
  ...
  const applyMeal = (plan, tot, target) => {
    if (!sc) return;
    const text = `?? ${plan.emoji} ${isAr ? plan.nameAr : plan.name}\n${"-".repeat(28)}\n${isAr ? "????? ??????" : "Daily Target"}: ${target} kcal | ${isAr ? "????????" : "Total"}: ${tot.cal} kcal\n${isAr ? "????????" : "Protein"}: ${tot.p}g | ${isAr ? "??????" : "Carbs"}: ${tot.c}g | ${isAr ? "??????" : "Fat"}: ${tot.f}g\n\n` +
        ...
        <div>
          ...
          <div className="card" style={{ padding: 18, marginBottom: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, flexWrap: "wrap", gap: 6 }}>
              <div>
                <div style={{ fontSize: 14, fontWeight: 700, color: G.gold }}>? {isAr ? "??? ???????" : "Workout Plan"}</div>
              ...
              {!editing ? (
                <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                  ...
                  {sc.workoutPlan && <Btn ch="???" v="danger" onClick={() => clearPlan(sc, "workout")} sx={{ padding: "6px 10px", fontSize: 11 }} />}
                </div>
          ...
          <div className="card" style={{ padding: 18, marginBottom: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, flexWrap: "wrap", gap: 6 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: G.green }}>?? {isAr ? "??? ???????" : "Nutrition Plan"}</div>
              {!editing ? (
                <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                  ...
                  {sc.nutritionPlan && <Btn ch="???" v="danger" onClick={() => clearPlan(sc, "nutrition")} sx={{ padding: "6px 10px", fontSize: 11 }} />}
                </div>
          ...
          {/* PDF DOWNLOAD */}
          <Btn ch={`?? ${isAr ? "????? PDF ??????" : "Download Full PDF (Client + Workout + Nutrition)"}`} v="gold" full onClick={() => generatePDF(sc, lang)} sx={{ padding: "13px", fontSize: 13, fontWeight: 700 }} />
        </div>
      )}
  ...
  return (
    <div className="fd">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14, flexWrap: "wrap", gap: 8 }}>
        ...
        <Btn ch={`+ ${isAr ? "?????" : "Update"}`} v="gold" onClick={() => setShowAdd(!showAdd)} sx={{ padding: "8px 14px", fontSize: 13 }} />
      </div>

      {/* Add Entry Form */}
      {showAdd && (
        <div className="card" style={{ padding: 16, marginBottom: 14, border: `1px solid ${G.borderHi}` }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: G.gold, marginBottom: 12 }}>?? {isAr ? "????? ??????" : "Log Progress"}</div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
            <div>
              <div style={{ fontSize: 10, color: G.muted, letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 6 }}>{isAr ? "????? (??)" : "Weight (kg)"}</div>
              <input className="inp" type="number" placeholder={`${client?.weight || 70}`} value={newWeight} onChange={e => setNewWeight(e.target.value)} />
            </div>
            <div>
              <div style={{ fontSize: 10, color: G.muted, letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 6 }}>{isAr ? "???????" : "Notes"}</div>
              <input className="inp" placeholder={isAr ? "???????" : "Optional"} value={newNotes} onChange={e => setNewNotes(e.target.value)} />
            </div>
          </div>
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontSize: 10, color: G.muted, letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 6 }}>?? {isAr ? "???? ??????" : "Progress Photo"}</div>
            <label style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", background: G.surf2, border: `1px dashed ${G.border}`, borderRadius: 10, cursor: "pointer" }}>
              ...
              <span style={{ fontSize: 13, color: G.muted }}>{newFile ? newFile.name : (isAr ? "???? ??????? ????" : "Tap to choose photo")}</span>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <Btn ch={uploading ? "?" : `? ${isAr ? "???" : "Save"}`} v="gold" onClick={addEntry} sx={{ flex: 1, padding: "11px", fontSize: 13 }} />
      ...
      {progress.length > 0 && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 12 }}>
          {[
            { l: isAr ? "???????" : "Start", v: `${startW}kg`, c: G.muted },
            { l: isAr ? "??????" : "Current", v: `${currentW}kg`, c: G.gold },
            { l: isAr ? "???????" : "Change", v: totalChange ? `${totalChange > 0 ? "+" : ""}${totalChange}kg` : "—", c: totalChange && parseFloat(totalChange) < 0 ? G.green : G.red },
          ].map(x => (
      ...
      {progress.length > 0 && (
        <div className="card" style={{ padding: 13, marginBottom: 14 }}>
          <div style={{ fontSize: 11, color: G.muted, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 10 }}>{isAr ? "??? ?????" : "Weight History"}</div>
      ...
      {/* Progress Photos */}
      <div>
        <div style={{ fontSize: 11, color: G.muted, letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 10 }}>{isAr ? "??? ??????" : "Progress Photos"}</div>
        {loadingPhotos ? (
          ...
          <div className="card" style={{ padding: "24px 16px", textAlign: "center", color: G.dim }}>
            ...
            <div style={{ fontSize: 12 }}>{isAr ? "?? ???? ??? ???" : "No photos yet"}</div>
          </div>
        ) : (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            {photos.map(ph => (
...
export default function App() {
  ...
  if (screen === "client" && liveC) {
    ...
    const bmiLabel = bmi < 18.5 ? (isAr ? "????" : "Underweight") : bmi < 25 ? (isAr ? "???" : "Healthy") : bmi < 30 ? (isAr ? "????? ???" : "Overweight") : (isAr ? "?????" : "Obese");
              ...
              <div className="card" style={{ padding: 14, marginBottom: 11 }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <div style={{ fontSize: 11, color: G.muted, lineHeight: 2.1 }}>
                    {[["<18.5", isAr ? "????" : "Underweight", G.amber], ["18.5–24.9", isAr ? "???" : "Healthy", G.green], ["25–29.9", isAr ? "????? ???" : "Overweight", G.amber], ["=30", isAr ? "?????" : "Obese", G.red]].map(([r, l, c]) => (
  ...
  return (
    <div style={{ minHeight: "100vh", background: G.bg, color: G.text }} dir={isAr ? "rtl" : "ltr"}>
      ...
      <div style={{ padding: 14, maxWidth: 860, margin: "0 auto" }}>
        ...
        {aTab === "dashboard" && (
          <div className="fd">
            ...
            {regs.length > 0 && <div style={{ background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.3)", borderRadius: 11, padding: "11px 13px", marginBottom: 12, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}><div><div style={{ fontSize: 13, fontWeight: 700, color: G.amber }}>?? {regs.length} {t.pendingRequests}</div></div><Btn ch={isAr ? "??????" : "Review"} v="amber" onClick={() => setATab("requests")} sx={{ padding: "7px 14px", fontSize: 12 }} /></div>}
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
              {[{ l: t.total, v: clients.length, c: G.gold }, { l: t.active, v: activeCount, c: G.green }, { l: t.pending, v: regs.length, c: G.amber }, { l: isAr ? "????? ???" : "With Plans", v: clients.filter(c => c.workoutPlan || c.nutritionPlan).length, c: G.blue }].map((s, i) => (
            ...
            <div className="card" style={{ padding: 14, marginBottom: 12, border: `1px solid ${G.borderHi}` }}>
              ...
              <div style={{ display: "flex", gap: 7 }}>
                ...
                <a href={`https://wa.me/?text=${encodeURIComponent(`${isAr ? "???? ?? Physical Definition:" : "Join Physical Definition! Register:"} ${regLink}`)}`} target="_blank" rel="noreferrer" style={{ ...VV.green, padding: "7px 13px", fontSize: 12, fontWeight: 600, borderRadius: 8, textDecoration: "none" }}>?? {isAr ? "??????" : "WhatsApp"}</a>
              </div>
            </div>
            <div className="card" style={{ padding: 16 }}>
              {(()=>{const today=new Date();today.setHours(0,0,0,0);const up=clients.filter(cl=>cl.dob).map(cl=>{const[,m,d]=cl.dob.split("-");let b=new Date(today.getFullYear(),+m-1,+d);if(b<today)b.setFullYear(today.getFullYear()+1);return{...cl,days:Math.ceil((b-today)/864e5)};}).filter(cl=>cl.days<=30).sort((a,b)=>a.days-b.days);if(!up.length)return null;return(<><div style={{fontSize:10,color:"#f59e0b",letterSpacing:1.5,textTransform:"uppercase",marginBottom:8,fontWeight:700}}>?? {isAr?"?????? ?????":"Upcoming Birthdays"}</div>{up.map(cl=>(<div key={cl.id} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"7px 0",borderBottom:`1px solid ${G.border}`}}><span style={{fontSize:13,color:G.text,fontWeight:600}}>{cl.name}</span><span style={{fontSize:12,color:cl.days<=7?"#f59e0b":G.muted,fontWeight:700}}>{cl.days===0?"?? Today!":cl.days===1?"Tomorrow ??":cl.days+" days"}</span></div>))}<div style={{height:1,background:G.border,margin:"12px 0"}}></div></>);})()}
              ...
              return (
                <div key={c.id} className="card" style={{ padding: 13, marginBottom: 9, opacity: disabled ? 0.6 : 1 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 5, marginBottom: 9 }}>
                    <Btn ch="??" v="ghost" onClick={() => openEdit(c)} sx={{ padding: "6px", fontSize: 12 }} />
                    ...
                    <Btn ch="???" v="danger" onClick={() => { if (window.confirm(`${isAr ? "???" : "Delete"} ${c.name}?`)) deleteClient(c.id); }} sx={{ padding: "6px", fontSize: 12 }} />
                  </div>
                    <div style={{ marginTop:10,padding:"10px 12px",background:"rgba(255,255,255,0.04)",borderRadius:10,border:`1px solid ${G.border}` }}>
                      <div style={{ fontSize:11,color:G.muted,marginBottom:5,fontWeight:600 }}>?? {isAr?"??????? ??????":"Trainer Notes"}</div>
                      <textarea value={notesDraft[c.id]??(c.trainer_notes||"")} onChange={e=>setNotesDraft(p=>({...p,[c.id]:e.target.value}))} onBlur={async()=>{if(notesDraft[c.id]!==undefined){const upd={...c,trainer_notes:notesDraft[c.id]};await dbUpdateClient(upd);setClients(p=>p.map(x=>x.id===c.id?upd:x));setNotesDraft(p=>{const n={...p};delete n[c.id];return n;});}}} placeholder={isAr?"??????? ????...":"Private notes..."} style={{width:"100%",minHeight:55,background:"transparent",border:"none",color:G.text,fontSize:12,resize:"none",outline:"none",lineHeight:1.6,fontFamily:"Inter,sans-serif",padding:0}} />
                    </div>
                  {c.phone && (() => {
                    const msg = `??? *Physical Definition*\n\n${isAr ? "??????" : "Hi"} ${c.name}!\n\n${isAr ? "?????? ?????" : "Your login details"}:\n\n?? *${isAr ? "??????" : "Email"}:* ${c.email}\n?? *${isAr ? "???? ??????" : "Password"}:* ${c.password}\n\n?? *App:* ${TRAINER.appUrl}\n\n${isAr ? "???? ?????? ????? ?????? ???????? ??" : "Open link & Add to Home Screen ??"}\n\n— ${TRAINER.name}`;
                    return (
      ...
      <Ovl show={showAdd} close={() => setShowAdd(false)} mw={480} ch={
        <div dir={isAr ? "rtl" : "ltr"}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <FF label={t.passwordAuto} value={form.password} onChange={v => sf("password", v)} ph={isAr ? "???? = ??????" : "Blank = auto"} />
      ...
      <Ovl show={showEdit} close={() => { setShowEdit(false); setEditC(null); }} mw={480} ch={
        <div dir={isAr ? "rtl" : "ltr"}>
          <div className="sf gd" style={{ fontSize: 18, fontWeight: 700, marginBottom: 16 }}>?? {t.edit}</div>
          {editC && <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <FF label={isAr ? "???? ???? ?????" : "New Password"} value={form.password} onChange={v => sf("password", v)} ph={isAr ? "???? = ??? ??????" : "Blank = keep"} />
      ...
      <Ovl show={showShare} close={() => setShowShare(false)} mw={420} ch={
        <div dir={isAr ? "rtl" : "ltr"}>
          ...
          {shareD && (() => {
            const credText = `??? *Physical Definition*\n\n${isAr ? "??????" : "Hi"} ${shareD.name}!\n\n${isAr ? "?????? ?????" : "Your login details"}:\n\n?? ${isAr ? "??????" : "Email"}:\n${shareD.email}\n\n?? ${isAr ? "???? ??????" : "Password"}:\n${shareD.password}\n\n?? *App:* ${TRAINER.appUrl}\n\n${isAr ? "???? ?????? ????? ?????? ???????? ??" : "Open link & Add to Home Screen ??"}\n\n— ${TRAINER.name}\n${isAr ? "???? ???? ?????" : "Certified Personal Trainer"}`;
            return (
              <>
  ...
  <div style={{ background:"rgba(255,255,255,0.06)",borderRadius:10,padding:"12px 14px",border:"1px solid rgba(255,255,255,0.08)" }}>
    <div style={{ fontSize:11,color:G.muted,marginBottom:6,fontWeight:600 }}>?? {isAr?"?????? ??????????":"Email"}</div>
    <div style={{ display:"flex",alignItems:"center",gap:8 }}>
      <div style={{ flex:1,fontSize:13,color:G.text,fontWeight:600,wordBreak:"break-all" }}>{shareD.email}</div>
      <button onClick={()=>navigator.clipboard.writeText(shareD.email)} style={{ flexShrink:0,background:"rgba(99,102,241,0.2)",border:"1px solid rgba(99,102,241,0.4)",borderRadius:7,padding:"6px 12px",color:"#a5b4fc",fontSize:12,cursor:"pointer",fontWeight:600 }}>?? {isAr?"???":"Copy"}</button>
    </div>
  </div>
  <div style={{ background:"rgba(255,255,255,0.06)",borderRadius:10,padding:"12px 14px",border:"1px solid rgba(255,255,255,0.08)" }}>
    <div style={{ fontSize:11,color:G.muted,marginBottom:6,fontWeight:600 }}>?? {isAr?"???? ??????":"Password"}</div>
    <div style={{ display:"flex",alignItems:"center",gap:8 }}>
      <div style={{ flex:1,fontSize:14,color:G.text,fontWeight:700,letterSpacing:2 }}>{shareD.password}</div>
      <button onClick={()=>navigator.clipboard.writeText(shareD.password)} style={{ flexShrink:0,background:"rgba(99,102,241,0.2)",border:"1px solid rgba(99,102,241,0.4)",borderRadius:7,padding:"6px 12px",color:"#a5b4fc",fontSize:12,cursor:"pointer",fontWeight:600 }}>?? {isAr?"???":"Copy"}</button>
    </div>
  </div>
</div>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <Btn ch={`?? ${isAr ? "??? ????" : "Copy Message"}`} v="ghost" full
                    onClick={() => { navigator.clipboard.writeText(credText); }}
                    sx={{ padding: "11px", fontSize: 13 }} />
                  <Btn ch={`?? ${isAr ? "??? ?????? ???" : "Copy Credentials Only"}`} v="ghost" full
